...
```shell
wget https://github.com/postmodern/ruby-install/releases/download/v0.10.2/ruby-install-0.10.2.tar.gz.asc
gpg --verify ruby-install-0.10.2.tar.gz.asc ruby-install-0.10.2.tar.gz
```
