...
## Install
    ...
    wget -O ruby-install-0.1.2.tar.gz https://github.com/postmodern/ruby-install/archive/v0.1.2.tar.gz
    tar -xzvf ruby-install-0.1.2.tar.gz
    cd ruby-install-0.1.2/
    sudo make install
...
with:
    ...
    wget https://raw.github.com/postmodern/ruby-install/master/pkg/ruby-install-0.1.2.tar.gz.asc
    gpg --verify ruby-install-0.1.2.tar.gz.asc ruby-install-0.1.2.tar.gz
