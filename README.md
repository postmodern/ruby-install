...
with:
    ...
    wget https://raw.github.com/postmodern/ruby-install/master/pkg/ruby-install-0.4.0.tar.gz.asc
    gpg --verify ruby-install-0.4.0.tar.gz.asc ruby-install-0.4.0.tar.gz
