...
function setUp()
{
	...
	expected_ruby_version="$(latest_version "$ruby_cache_dir/stable.txt" "$ruby_version")"
}

function test_load_functions()
{
	load_functions
...
function test_load_functions_with_ruby_url()
{
...
function test_load_functions_ruby_md5()
{
	load_functions
...
function test_load_functions_with_ruby_md5()
{
