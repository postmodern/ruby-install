...
function test_ruby_archive_when_its_already_set_and_when_ruby_version_is_greater_equal_to_23_0_0()
{
	ruby_version="23.0.0"
...
function test_ruby_mirror_when_its_already_set_and_when_ruby_version_is_greater_or_equal_to_23_0_0()
{
	ruby_version="23.0.0"
...
function test_ruby_url_default_value_when_ruby_version_is_greater_or_equal_to_23_0_0()
{
	ruby_version="23.0.0"
...
function test_ruby_url_when_its_already_set_and_ruby_version_is_greater_equal_to_23_0_0()
{
	ruby_version="23.0.0"
